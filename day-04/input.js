...
const requiredHighSecurity = [
  { field: 'byr', regex: /^\d{1,4}$/, min: 1920, max: 2002 }, // (Birth Year)
  { field: 'iyr', regex: /^\d{1,4}$/, min: 2010, max: 2020 }, // (Issue Year)
  { field: 'eyr', regex: /^\d{1,4}$/, min: 2020, max: 2030 }, // (Expiration Year)
  { field: 'hgt', regex: /^\d+(cm|in)$/, min: 150, max: 193 }, // (Height)
  { field: 'hcl', regex: /^#+([0-9]|[A-F]){6}$/i}, // (Hair Color)
  { field: 'ecl', regex: null, values: ['amb','blu','brn','gry','grn','hzl','oth'] }, // (Eye Color)
  { field: 'pid', regex: /^[0-9]{9}$/ }, // (Passport ID)
];